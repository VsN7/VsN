...
public class ContaReceberView extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "1 vez", "2 vezes", "3 vezes", "4 vezes", "5 vezes", "6 vezes", "7 vezes", "8 vezes", "9 vezes", "10 vezes", "11 vezes", "12 vezes" }));
        ...
        inputDataCompra.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try {
            PagamentoContasReceberView pv = new PagamentoContasReceberView();
                ...
                try{
                    ...
                    do{
                        if(id == cc.getContas().get(i).getId()){
                            PagamentoContasReceberView pcpv = new PagamentoContasReceberView();
                            pcpv.setIndex(i);
                        }
                        iterator.next();
    ...
    public void valoresInputConta(){
        PagamentoContasReceberView.inputTitulo.setText(""+conta.getTitulo());
        PagamentoContasReceberView.inputValor.setText(""+formatter.format(conta.getValor()));
        PagamentoContasReceberView.inputDataCompra.setText(""+sdf.format(conta.getDataCompra().getTime()));
        PagamentoContasReceberView.inputVezes.setText(""+conta.getVezes());
        PagamentoContasReceberView.inputValorParcela.setText(""+formatter.format((conta.getValor()/conta.getVezes())));
        PagamentoContasReceberView.inputVezesRestantes.setText(""+conta.getVezesPagar());
        PagamentoContasReceberView.inputValorRestante.setText(""+formatter.format(conta.getValorPagar()));
        PagamentoContasReceberView.inputDataVencimento.setText(""+sdf.format(conta.getDataVencimento().getTime()));
        PagamentoContasReceberView.inputSituacao.setText(""+conta.getSituacao());
    }
