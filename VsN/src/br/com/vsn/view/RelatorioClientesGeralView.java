 ...
 * @author vitor
 */
public class RelatorioClientesGeralView extends javax.swing.JInternalFrame {
    ...
    public RelatorioClientesGeralView() {
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("Clientes Geral");

        jLabel1.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel1.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel1.setText("Filtro de Clientes Geral");
    ...
    private void buttonImprimirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonImprimirActionPerformed
        try{
            if(!inputId.getText().equals("")){
                ...
                cc.relatorioClienteGeral(id, nome, situacao);
