...
public class FornecedorView extends javax.swing.JInternalFrame {
    ...
    public FornecedorView() throws Exception {
    ...
    private void initComponents() {
        ...
        jLabel18.setText("Endereço do Fornecedor");
        ...
        jLabel28.setText("Contato do Fornecedor");
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(inputNomeFantasia, javax.swing.GroupLayout.PREFERRED_SIZE, 300, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void buttonFinaljButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonFinaljButton8ActionPerformed
        index = fc.getFornecedores().size()-1;
        exibirDados();
    ...
    private void buttonProximojButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonProximojButton7ActionPerformed
        if(index < fc.getFornecedores().size()-1){
            posterior();
        }
        exibirDados();
    ...
    private void buttonEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonEditarActionPerformed
        ...
        if(buttonEditar.getText().equals("Salvar")){
            try {
                this.valoresInput();
                fc = new FornecedorController();
                fc.editFornecedor(Integer.parseInt(inputId.getText()), razaoSocial, nomeFantasia, icms, cnpj, inscricaoEstadual, longradouro, numero, bairro, cidade, estado, cep, telefone, email,situacao);
                buttonEditar.setText("Editar");
                this.ativarTudo();
                this.exibirDados();
            } catch (Exception ex) {
        ...
        if(buttonSelecionar.getText().equals("Buscar")){
            try {
                ...
                do{
                    ...
                    iterator.next();
                    if(i<fc.getFornecedores().size()-1)
                        i++;
    ...
    private void buttonCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonCadastrarActionPerformed
        if(buttonCadastrar.getText().equals("Salvar")){
            try {
                this.valoresInput();
                fc = new FornecedorController();
                fc.salvarFornecedor( razaoSocial, nomeFantasia, icms, cnpj, inscricaoEstadual, longradouro, numero, bairro, cidade, estado, cep, telefone, email);
                buttonCadastrar.setText("Novo");
                index = fc.getFornecedores().size()-1;
                this.ativarTudo();
                this.exibirDados();
...
//            }
    ...
    public int posterior(){
        ...
        try {
            this.ativarTudo();
            inputId.setText(""+fc.getFornecedores().get(index).getId());
            inputRazaoSocial.setText(""+fc.getFornecedores().get(index).getRazaoSocial());
            inputNomeFantasia.setText(""+fc.getFornecedores().get(index).getNomeFantasia());
            comboIcms.setSelectedItem((String) fc.getFornecedores().get(index).getContribuinteIcms());
            inputCnpj.setText(""+fc.getFornecedores().get(index).getCnpj());
            inputInscricaoEstadual.setText(""+fc.getFornecedores().get(index).getInscricaoEstadual());
            inputLongradouro.setText(""+fc.getFornecedores().get(index).getLongradouro());
            inputNumero.setText(""+fc.getFornecedores().get(index).getNumero());
            inputBairro.setText(""+fc.getFornecedores().get(index).getBairro());
            inputCidade.setText(""+fc.getFornecedores().get(index).getCidade());
            comboEstado.setSelectedItem((String) fc.getFornecedores().get(index).getEstado());
            inputCep.setText(""+fc.getFornecedores().get(index).getCep());
